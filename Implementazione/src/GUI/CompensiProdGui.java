...
public class CompensiProdGui 
{
	...
	public CompensiProdGui(ControllerProduttore controller,JFrame adminGui,Utente utente)
	{
		System.out.println("Ti trovi in CompensiProdGui");
		...
		listProduttore=controller.listaCompensiProduttori();
		DefaultListModel<String> model = new DefaultListModel<String>();
		listPr = new JList<String>(model);
			
		for(Produttore varTr: listProduttore)
		{
			model.addElement(varTr.getNome()+"-"+varTr.getCompensi()+"E");
		}
		...
		indietro.setBounds(410, 615, 250, 45);
