...
public class ListaAlbum 
{
	...
	public ListaAlbum(ControllerAlbum controller,JFrame clientGui,Utente utente)
	{
		System.out.println("ti trovi in lista album");
	...
	public ListaAlbum(ControllerAlbum controller,JFrame adminGui,Utente utente,int codice) 
	{
		System.out.println("Ti trovi in ListaAlbum2");
