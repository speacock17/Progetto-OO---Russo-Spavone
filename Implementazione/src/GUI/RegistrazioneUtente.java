...
public class RegistrazioneUtente extends JFrame
{
	...
	public RegistrazioneUtente(JFrame loginGui, ControllerUtente controller) 
	{
		...
		avanzaRegistrazione.addMouseListener(new MouseAdapter() 
		{
			...
			{
				int esitoControllo;
				int esitoControlloUnicitaMail;
				boolean esitoControlloMail;
				esitoControlloMail=Utente.correttezzaMail(inserimentoMail.getText());
				esitoControllo=controller.unicitaUtente(inserimentoNomeUtente.getText());
				esitoControlloUnicitaMail=controller.unicitaMail(inserimentoMail.getText());
				System.out.println("esito"+esitoControllo);
				if(esitoControllo==1)
				{
					JOptionPane.showMessageDialog(avanzaRegistrazione, "Nome Utente gia' utilizzato.");
				}
				...
				{
					JOptionPane.showMessageDialog(avanzaRegistrazione, "Errore, la tua Mail non e' valida.");
				}
				else if(esitoControlloUnicitaMail==1)
				{
					JOptionPane.showMessageDialog(avanzaRegistrazione, "Mail gia' registrata alla piattaforma.");
				}
				else
				{
